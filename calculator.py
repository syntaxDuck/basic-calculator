...
class DefaultButton:
    ...
    def __init__(self, row, col, text, root):
        ...
        self.button = tk.Button(
            root, text=text, font=tkfont.Font(size=12, weight="bold")
        )
        self.button.grid(
            row=row, column=col, ipadx=40, ipady=20, padx=1, pady=1, sticky="NESW"
        )
...
class CalculatorEntry:
    ...
    def __init__(self, row, col, root):
        ...
        self.entry.grid(
            row=row, column=col, columnspan=5, padx=5, pady=5, sticky="NESW"
        )
